...
launch_terminal_tabs "$PROJECT_NAME" "$FRONTEND_CMD" "$BACKEND_CMD" "$DATABASE_CMD" "5000"
...
echo -e "${YELLOW}Database: PostgreSQL listening on localhost:5432 (database: invoiceme).${NC}"
