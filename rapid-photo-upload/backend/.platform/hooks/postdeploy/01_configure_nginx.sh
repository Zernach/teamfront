...
if grep -q "# CUSTOM RAPID-PHOTO-UPLOAD CONFIG" "$NGINX_APP_CONF"; then
...
# Create proxy settings optimized for WebSocket and long-running connections
PROXY_SETTINGS="
${INDENT}# CUSTOM RAPID-PHOTO-UPLOAD CONFIG
